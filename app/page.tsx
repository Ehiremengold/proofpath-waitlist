  ...
  if (submitted) {
    return (
      <div className="glass animate-fade-up opacity-0" style={{ animationFillMode: "forwards", borderRadius: 20, padding: "2rem", textAlign: "center", maxWidth: 400, margin: "0 auto" }}>
        ...
        <p style={{ fontSize: "0.875rem", color: C.textMuted, lineHeight: 1.6, marginBottom: "1.5rem" }}>We&apos;ll reach out as soon as we're live. Your proof is coming, sit tight.</p>
        <p style={{ fontSize: "0.8rem", color: C.textDim, marginBottom: "0.75rem", textTransform: "uppercase", letterSpacing: "0.08em", fontWeight: 600 }}>Spread the word</p>
        <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
          <a
            href={`https://twitter.com/intent/tweet?text=${encodeURIComponent("We think hiring and job seeking is broken, redundant and stressful so we are building proofpath. Join the waitlist here:")}&url=${encodeURIComponent("https://proofpath-waitlist.vercel.app")}`}
            target="_blank" rel="noopener noreferrer"
            style={{
              display: "flex", alignItems: "center", gap: 7, padding: "9px 18px",
              borderRadius: 999, fontSize: "0.82rem", fontWeight: 600, cursor: "pointer",
              background: C.glass, border: `1px solid ${C.border}`, color: C.white,
          ...
          <a
            href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://proofpath-waitlist.vercel.app")}`}
            target="_blank" rel="noopener noreferrer"
            style={{
              display: "flex", alignItems: "center", gap: 7, padding: "9px 18px",
              borderRadius: 999, fontSize: "0.82rem", fontWeight: 600, cursor: "pointer",
